-- =============================================
-- CORREÇÃO FINAL: SEARCH PATH NAS FUNÇÕES RPCs
-- =============================================

-- Corrigir as duas funções que estão sem search_path

-- 1. Corrigir get_available_user_plans
...
DECLARE
  v_user_plan_id uuid;
BEGIN
  -- Buscar um plano ativo do usuário que não foi usado e não expirou
