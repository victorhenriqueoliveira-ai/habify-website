      ...
      <div className="container px-4 sm:px-6 lg:px-8 relative z-10" ref={containerRef}>
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-16 items-center">
          ...
          <div className="w-full lg:w-1/2 space-y-6 lg:space-y-8">
            ...
            >
              <strong className="text-foreground">Pare de perder clientes para corretores que já têm site.</strong> Sua landing page profissional pronta em 72h — leads direto no WhatsApp automaticamente, SEO otimizado, plataforma própria em React.js. Pagamento único a partir de R$ 300,00.
            </p>
